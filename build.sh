...
用法: ./build.sh [选项]
  ...
  -D, --device <机型>     xg-040g-md|xg-040g-mf|zn504xg-d，默认 xg-040g-md
...
case "$DEVICE" in
    ...
    zn504xg-d)
        ...
        ;;
    *)
        die "不支持的机型: $DEVICE（可选 xg-040g-md|xg-040g-mf|zn504xg-d）"
        ;;
esac
...
case "$DEVICE_SYMBOL" in
    ...
    nokia_xg-040g-md-ubi|nokia_xg-040g-mf-ubi|znxt_zn504xg-d)
