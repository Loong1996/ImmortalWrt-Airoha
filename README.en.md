...
2. `Actions → ImmortalWrt-Airoha → Run workflow`. Pick a model (`xg-040g-md` / `xg-040g-mf` / `xg-040g-tf` / `zn504xg-d`, or `all` to build every model in parallel) and a variant. Memory size defaults to [auto](docs/variants.md#内存容量). Leave it.
